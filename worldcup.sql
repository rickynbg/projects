...
--
-- Name: games games_teams_opponent; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_teams_opponent FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games games_teams_winner; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_teams_winner FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
