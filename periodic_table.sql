...
--
-- Name: properties properties_types; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_types FOREIGN KEY (type_id) REFERENCES public.types(type_id);


--
-- Name: properties propoerties_elements; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT propoerties_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
